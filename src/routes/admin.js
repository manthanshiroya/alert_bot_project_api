 ...
 *     description: Retrieves a list of pending subscriptions that require admin approval
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     responses:
 *       200:
 *         description: Pending subscriptions retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *         description: Internal server error
 */
router.get('/subscriptions/pending', verifyAdminToken, adminController.getPendingSubscriptions);
 ...
 *     description: Approves a pending subscription
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *         description: Internal server error
 */
router.post('/subscriptions/:subscriptionId/approve', verifyAdminToken, validateSubscriptionApproval, adminController.approveSubscription);

/**
 * @swagger
 * /api/admin/subscriptions/{subscriptionId}/reject:
 *   post:
 *     tags: [Subscription Management]
 *     summary: Reject subscription
 *     description: Rejects a pending subscription
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *                 message:
 *                   type: string
 *                   example: Subscription rejected successfully
 *       400:
 *         description: Invalid input data
 *       401:
 *         description: Unauthorized - Invalid or missing admin token
 ...
 *         description: Internal server error
 */
router.post('/subscriptions/:subscriptionId/reject', verifyAdminToken, validateSubscriptionRejection, adminController.rejectSubscription);
